...
export const businessModel = {
  ...
  mainPlanConditions:
    "24か月未満の中途解約金は、残契約月数×9,800円（税込）です。24か月経過後の解約金はなく、次回決済日の10日前までにお申し出ください。独自ドメイン代と外部有料サービスは別途です。",
  demoNotice:
...
export const faqItems: readonly FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "サービス内容は同じです。初期費用0円型は月額9,800円、月額負担軽減型は初期49,800円・月額5,980円で、どちらも最低利用期間は24か月です。月額負担軽減型の中途解約条件は、お申し込み前に個別契約でご案内します。",
  },
  {
    question: "Webスタートを24か月未満で解約できますか？",
    answer:
      "初期費用0円・月額9,800円型を最低利用期間中に解約する場合、中途解約金は残契約月数に9,800円（税込）を乗じた金額です。24か月経過後の解約金はありません。解約は次回決済日の10日前までにお申し出ください。",
  },
  {
  ...
  {
    question: "多言語対応のホームページ制作はできますか？",
    answer:
      "はい。英語1言語分のAI翻訳ページ制作は、各プランのページ数上限内で追加料金なしの標準対応です。中国語（簡体字）・韓国語への対応、ネイティブ翻訳者による校正、ページ数上限を超える追加翻訳は別途お見積もりします。",
  },
] as const;
