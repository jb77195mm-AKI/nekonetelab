...
export const webPlans: WebPlan[] = [
  {
    ...
    notices: [
      ...
      "最低利用期間終了後は1か月単位で自動更新します。解約は次回決済日の10日前までにお申し出ください。",
      "月額負担軽減型の中途解約条件は、お申し込み前に個別契約でご案内します。",
      "更新枠は翌月へ繰り越しません。",
...
export const webPlanComparisonRows = [
  ...
  { label: "多言語ページ制作（英語）", webStart: "標準・追加料金なし", webSupport: "標準・追加料金なし", buyout: "標準・追加料金なし" },
