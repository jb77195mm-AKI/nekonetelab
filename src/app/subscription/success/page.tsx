      ...
      <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6 sm:py-20">
        <div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-7 sm:p-10">
          <CheckCircle2
            ...
            aria-hidden="true"
          />
          <h2 className="mt-5 text-2xl font-black">確認用フローが完了しました</h2>
          ...
          <p className="mt-4 rounded-xl bg-white px-4 py-3 text-xs leading-6 text-slate-600">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2">
          ...
          {siteConfig.customerPortalUrl ? (
            <a
              ...
              className="flex min-h-12 items-center justify-center rounded-full border border-sky-200 bg-sky-50 px-6 py-3 font-bold text-sky-950 sm:col-span-2"
            >
              Stripeテスト用Customer Portalを確認
            </a>
          ) : (
            <p className="rounded-xl bg-slate-50 px-4 py-3 text-center text-sm text-slate-600 sm:col-span-2">
